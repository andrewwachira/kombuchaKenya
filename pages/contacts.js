						...
						<div style={{display: "block", backgroundColor: "white", width: "600px", height:"inherit", borderRadius: "10px", boxShadow: "rgba(0, 0, 0, 0.4) 2px 2px 6px", font: "400 15px / 1.3 -apple-system, BlinkMacSystemFont, Roboto, Open Sans,Helvetica Neue, sans-serif", marginBottom:"25px"}}>
							<div id="whatsappChatWidgetHeaderPreview" style={{height: "100px", maxHeight: "100px", minHeight: "100px", backgroundColor: "rgb(10, 95, 84)", color: "white", borderRadius: "10px 10px 0px 0px", display: "flex", alignItems: "center"}}>
								...
								<div style={{cursor: "pointer", position: "absolute", right: "20px", top: "20px"}}>
									...
									<img src="https://cdn.shopify.com/s/files/1/0070/3666/5911/files/Vector.png?574" style={{display: "table-row"}} alt="Vector" class="lazyloaded" data-ll-status="loaded"/>
									
									<img src="https://cdn.shopify.com/s/files/1/0070/3666/5911/files/Vector.png?574" data-src="https://cdn.shopify.com/s/files/1/0070/3666/5911/files/Vector.png?574" style={{display: "table-row"}} alt="Vector" class="lazyloaded  lazy-loaded" data-ll-status="loaded"/>
							...
							<div id="whatsappChatWidgetButtonPreview" style={{backgroundColor: "white", paddingBottom: "2px", borderRadius:"10px"}}>
								<a id="whatsappChatWidgetStartChat" role="button" href="https://api.whatsapp.com/send/?phone=254729302487" title="WhatsApp" style={{textDecoration: "none", color: "rgb(255, 255, 255)", fontSize: "15px", fontWeight: "700", lineHeight: "20px", cursor: "pointer", position: "relative", display: "flex", justifyContent: "center", alignItems: "center", padding: "8px 12px", borderRadius: "25px" , border: "none", backgroundColor: "rgb(77, 194, 71)", margin: "20px", overflow: "hidden"}} rel="noreferrer noopener">
									<svg width="20" height="20" viewBox="0 0 90 90" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd" style={{ width: "16px" , height: "16px", fill: "rgb(255, 255, 255)", zIndex: "1", flex: "0 0 16px"}}> 
